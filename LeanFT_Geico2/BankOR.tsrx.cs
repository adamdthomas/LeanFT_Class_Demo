...
namespace LeanFT_Geico2
{
	...
	public class BankOR : AppModelBase
	{
		#region Constructors

		public BankOR(ITestObject contextTestObject)
		{
			Name = @"BankOR";
			AbcBankDemoPage = new AbcBankDemoPageNode(contextTestObject, this);
			RebuildDescriptions();
		...
		public AbcBankDemoPageNode AbcBankDemoPage { get; private set; }
	
		#endregion
	
		#region Inner Classes
	
		public sealed class AbcBankDemoPageNode : PageNodeBase
		{
			#region Constructors
			...
			public UserUsernameEditFieldNode UserUsernameEditField { get; private set; }
			public UserPasswordEditFieldNode UserPasswordEditField { get; private set; }
			public LoginButtonNode LoginButton { get; private set; }
			public LogoutButtonNode LogoutButton { get; private set; }
		
			#endregion
		
			#region Inner Classes
		
			public sealed class UserUsernameEditFieldNode : EditFieldNodeBase
			{
				#region Constructors
			
				public UserUsernameEditFieldNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
			...
			public sealed class UserPasswordEditFieldNode : EditFieldNodeBase
			{
				#region Constructors
			
				public UserPasswordEditFieldNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
			...
			public sealed class LogoutButtonNode : ButtonNodeBase
			{
				#region Constructors
			
				public LogoutButtonNode(ITestObject parent, AppModelBase applicationModel) : base(parent, applicationModel)
				{
					DisplayName = @"Logout";
				}
